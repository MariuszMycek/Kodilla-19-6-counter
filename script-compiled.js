...
lapButton.addEventListener("click", function () {
  return stopwatch.lapTime();
});

var resetLapsButton = document.getElementById("resetLaps");
resetLapsButton.addEventListener("click", function () {
  return stopwatch.resetLaps();
});
